...
zip_code_info <- evictions_by_zip_code %>% 
  inner_join(homelessness_by_zip_code, by = c("eviction_zip" = "incident_zip"), suffix = c("_eviction", "_homelessness"))

ggplot(zip_code_info, aes(n_homelessness, n_eviction)) + geom_point(jitter = TRUE)
